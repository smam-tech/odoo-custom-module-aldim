...
class unitek_hitoko_product_template_model(models.Model):
    ...
    #         unitek_hitoko_product_template_model.hitoko_get_image_link(template)


    def hitoko_get_image_link(self,singlerecord=""):
        if singlerecord != "":
            imglink = self.env['unitek.imgbb'].convert_image_to_link(self,singlerecord.image_1920)
        ...
        for template in self:
            ...
            imglink = self.env['unitek.imgbb'].convert_image_to_link(self,template.image_1920)
